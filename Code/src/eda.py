...
def summarize(col:str, df:pd.DataFrame, enforce_counts:bool = False):
...
def summarize_entire(df:pd.DataFrame, enforce_counts:bool = False):
    for col in df.columns:
        summarize(col, df, enforce_counts)